...
BACKUP_SCRIPT_DIR="$HOME/backups.sh"  # path to the actual script location
SOURCE_DIR="$HOME/backups"       # path to the directory to be backed up
# Linux
# /run/media/felipe/0C91-9A88/backups
#
BACKUP_DIR="/run/media/felipe/0C91-9A88/backups"  # path to the directory where backups will be saved
DIR_BACKUPS_EXTERNAL="/run/media/felipe/0C91-9A88/backups"  # Path to copy the .gpg file to the SD card
